 ...
 */
FARPROC WINAPI performDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = performDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = performDelayLoadWin32FailureHook;
#endif
